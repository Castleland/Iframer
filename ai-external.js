 ...
 *  Created: 2018-08-08 12:04:38
*/
/* jslint devel: true, evil: false */
if (typeof domain_advanced_iframe === 'undefined') {
    var domain_advanced_iframe = 'http://dicdevelopmenttrust.com/Redux/wp-content/plugins/advanced-iframe'; // Check if this is this is the path to the main directory of aip
}
...
if (doIt) {
  ...
  if (typeof resize_on_element_resize === 'undefined') {
      var resize_on_element_resize = 'div#Wrapper';
  }
